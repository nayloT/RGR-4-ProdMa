...
# ============================================================
# 2. Численная реализация ряда Фурье
# ============================================================
...
# ============================================================
# 1.2 Аналитические разложения функций
# ============================================================
...
def analytical_coeffs_f2(N):
    """Аналитические коэффициенты для f(x)=|x|"""
    a = np.zeros(N + 1)
    b = np.zeros(N + 1)  # b_n = 0 для четной функции
    a0 = np.pi
    for n in range(1, N + 1):
        if n % 2 == 0:
            a[n] = 0
...
def analytical_coeffs_f3(N):
    ...
    a = np.zeros(N + 1)  # a_n = 0 для нечетной функции
    b = np.zeros(N + 1)
    a0 = 0
    for n in range(1, N + 1):
        if n % 2 == 0:
...
# ============================================================
# 3. Исследование сходимости для всех трех функций
# ============================================================
...
# ============================================================
# 4. Применение к реальному датасету (температура)
# ============================================================
